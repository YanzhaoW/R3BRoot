...
namespace R3B::Neuland::Calibration
{
    ...
    class HitCalibrationBar
    {
      ...
      public:
        ...
        inline Double_t GetTime() const { return 0.5 * (currentHit_.Time[0] + currentHit_.Time[1]); }
        inline Double_t GetPosition() const { return currentHit_.EntryPosition; }
