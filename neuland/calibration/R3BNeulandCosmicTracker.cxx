...
namespace R3B::Neuland::Calibration
{
    ...
    {
        return WithinBounds(point[0], xBounds) && WithinBounds(point[1], yBounds) && WithinBounds(point[2], zBounds);
    }
    ...
    void CosmicTracker::AddPoint(Int_t barID, Double_t pos)
    {
    ...
    auto CosmicTracker::GetTrack() -> const R3BNeulandCosmicTrack&
    {
    ...
    DPair CosmicTracker::linearRegression(const Double_t* x, const Double_t* y, const Int_t points) const
    {
        ...
        const auto xVar =
            invRedPoints *
            std::accumulate(
                x, x + points, 0., [xMean](const Double_t acc, const Double_t val) { return acc + Sqr(val - xMean); });
        ...
        const auto yVar =
            invRedPoints *
            std::accumulate(
                y, y + points, 0., [yMean](const Double_t acc, const Double_t val) { return acc + Sqr(val - yMean); });
