...
ROOT::Math::XYZVector R3BNeulandGeoPar::ConvertToLocalCoordinates(const ROOT::Math::XYZVector& position,
                                                                  const Int_t paddleID) const
{
    ...
    return ROOT::Math::XYZVector(pos_out[0], pos_out[1], pos_out[2]);
}

ROOT::Math::XYZVector R3BNeulandGeoPar::ConvertToGlobalCoordinates(const ROOT::Math::XYZVector& position,
                                                                   const Int_t paddleID) const
{
    Double_t pos_in[3] = { position.X(), position.Y(), position.Z() };
    Double_t pos_tmp[3];
...
ROOT::Math::XYZVector R3BNeulandGeoPar::ConvertGlobalToPixel(const ROOT::Math::XYZVector& position) const
{
